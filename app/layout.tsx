			...
			<body className={inter.className}>
				...
				<Suspense>
					<div className="absolute bottom-[10px] left-[10px] text-xs text-muted-foreground z-[9999]">
						...
						APIs for Karma, Nova and the Goober Project are provided by third parties. &mdash; <a href="/legal" className="text-blue-500 underline pointer-events-auto z-501">Terms</a>
					</div>
				</Suspense>
				{/* <Suspense>
					<VercelToolbar/>
